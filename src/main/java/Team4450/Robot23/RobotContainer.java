...
import Team4450.Robot23.commands.AimBotNFO;
...
import Team4450.Robot23.commands.ToggleScoreMode;
...
public class RobotContainer 
{
	...
	//determine whether the drives want to target reflective tape or april tag.
	...
	public RobotContainer() throws Exception
	{
		...
		arm = new Arm(winch);
		claw = new Claw();
		phCamera = new PhotonCamera("LL-4450");
	...
	private void configureButtonBindings() 
	{
		...
		new Trigger(() -> driverPad.getLeftBumper())
			.onTrue(new ToggleScoreMode());
		
		new Trigger(() -> driverPad.getPOVAngle(0))
		...
		new Trigger(() -> utilityPad.getLeftTrigger()).toggleOnTrue(new CloseClaw(claw, 14000));
	...
	/*
	private void toggleScoreMode(){

		if(scoreMode == ScoreMode.CONE)
			scoreMode = ScoreMode.CUBE;
		else
